        ...
        <div className="contentComponent1">
          <div className="shadow">
            ...
            <div className="contentComponent1Info">
              <p>This page contains Website build options. If you click on the image of the build option you are interested in, it will show you a prototype image and list some of that pages functionality.</p>
              <br />
              <p>Please note these are just basic designs for illustrative purposes. I will work with you to achieve specific layouts and designs.</p>
            </div>
          </div>
        </div>
